...
void nueva_impresora(TLISTA *cadena_impresoras); /* AÑADE UNA IMPRESORA A LA LISTA Y DA ERROR SI YA EXISTE UNA IMPRESORA CON EL MISMO NOMBRE*/
...
void imprimir_traballo(TLISTA cadena_impresoras, TIPOELEMENTOLISTA impresora); /*ELIMINA EL PRIMER ELEMENTO DE LA COLA DE IMPRESION DE UNA IMPRESORA*/
void encontrar_impresora_poca_carga(TLISTA lista); /*ENCUENTRA LAS IMPRESORAS CUYA COLA DE IMPRESION ES MENOR*/
void cargar_impresoras(FILE* file, TLISTA cadena_impresoras); /*CARGA TODAS LAS IMPRESORAS DE impresoras.txt A LA LISTA Y CREA UNA COLA DE IMPRESIÓN VACÍA*/
